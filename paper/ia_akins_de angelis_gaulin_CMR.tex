...
% First 'footnote' is the citation format, denoted by asterix
...
\label{IApp:vardef}
\vspace{-1em}
\input{./tables/ia/ia_variable_definitions}
...
\begin{papertable}{Sample Construction}{\ref{IAtab:sampconstruct}}{\vspace{8pt}}
    ...
    \startdata
    \input{./tables/ia/table_ia_sample_construction}
\end{papertable}
...
\begin{landscapepapertable}{CMR Clause Characteristics}{\ref{IAtab:abcdtype}}{}
  \label{IAtab:abcdtype}
    ...
    \startdata
    \def\arraystretch{.9}
    \input{./tables/ia/table_ia_CMR_categories}
...
\begin{papertable}{Additional Summary Statistics}{\ref{IAtab:yearind}}{}
    ...
    \startdata
    \input{./tables/ia/table_ia_year_industry}
    \splittable
    {
    \begin{tabular}{l*{4}{c}}
    \toprule
    \multicolumn{5}{c}{\small \centering {Panel B}: CEO Turnover Data Set} \\ \midrule
    \input{./tables/ia/table_ia_ceo_turnover_summary_stats}
    \midrule
    \multicolumn{5}{c}{\small \centering {Panel C}: CEO Turnover and Covenant Violation Analysis} \\
    \midrule
    \input{./tables/ia/table_ia_ceo_turnover_cov_viol_summary_stats}
    \bottomrule
    \end{tabular}
    }
    \splittable
    \input{./tables/ia/table_ia_ia_summary_stats}
\end{papertable}


% Table IA.IV CMR Determinant + additional controls  :  \ref{IAtab:cmrdeterm_spread}
\begin{papertable}{Multivariate Analysis--Baseline Specifications}{\ref{IAtab:cmrdeterm_spread}}{} \label{IAtab:cmrdeterm_spread}
    ...
    \startdata
    \input{./tables/ia/table_ia_baseline_specifications_spreads}
\end{papertable}


% Table IA.V CMR Determinant + additional controls  :  \ref{IAtab:robust_additional_det}
\begin{papertable}{Debt Overhang, Large Block, and Takeover Threat Considerations}{\ref{IAtab:robust_additional_det}}{}
  ...
  \startdata
  \input{./tables/ia/table_ia_determinants_plus}
...
% Table IA.VI HC - Alternative Founder  :  \ref{IAtab:robust_ceo_founder}
\begin{papertable}{Alternative Definition of Founder CEO}{\ref{IAtab:robust_ceo_founder}}{}
  ...
  \startdata
  \input{./tables/ia/table_ia_robust_human_capital}
\end{papertable}




% Table IA.VII Firm Age Robustness  :  \ref{IAtab:robust_firm_age}
\begin{landscapepapertable}{Firm Age Robustness}{\ref{IAtab:robust_firm_age}}{}
  ...
  \startdata
  \input{./tables/ia/table_ia_crsp_age_controls}
\end{landscapepapertable}




% Table IA.VIII Human Capital granular
\begin{papertable}{CMR Clause Inclusion and Human Capital -- A More Granular Specification} {\ref{IAtab:granular_humancap}}{}
    ...
    \startdata
    \input{./tables/ia/table_ia_human_capital_subsets}
...
% Table IA.IV HC/Friction + CIC  :  \ref{IAtab:robust_cic}
\begin{papertable}{Controlling for the Presence of a Change in Control Covenant}{\ref{IAtab:robust_cic}}{}
  ...
  \startdata
  \input{./tables/ia/table_ia_with_cic}
\end{papertable}
...
% Table IA.X HC/Friction + Extra loan controls  :  \ref{IAtab:robust_loan_cont}
\begin{papertable}{Controlling for Additional Features of the Loan Contract}{\ref{IAtab:robust_loan_cont}}{}
  ...
  \startdata
  \input{./tables/ia/table_ia_with_loan_controls}
\end{papertable}
...
% Table IA.XI CMR Pricing Facility level  :  \ref{IAtab:robust_facility_pricing}
\begin{papertable}{CMR Inclusion and Predicted Yield Differential -- Facility Level Specification}{\ref{IAtab:robust_facility_pricing}}{}
  ...
  \startdata
  \input{./tables/ia/table_ia_facility_pricing}
  % Add: \addlinespace \textit{Average Marginal Effect}
...
% Table IA.XII CMR Pricing restrictive A123 / A4  :  \ref{IAtab:robust_severity_pricing}
\begin{papertable}{CMR Inclusion and Predicted Yield Differential -- Most~Restrictive CMR vs. Least Restrictive CMR Specification}{\ref{IAtab:robust_severity_pricing}}{}
  \label{IAtab:robust_severity_pricing}
    ...
    \startdata
    \input{./tables/ia/table_ia_cmr_severity_pricing}
    % Add: \addlinespace \textit{Average Marginal Effect}
...
% Table IA.XIII CEO Turnover - Alternative binding  :  \ref{IAtab:robust_turnover_alt_bind}
\begin{papertable}{The Presence of a CMR Clause and CEO Turnover -- Alternative~CMR Binding Specification}{\ref{IAtab:robust_turnover_alt_bind}}{}
  ...
  \startdata
  \input{./tables/ia/table_ia_alternate_ceo_turnover}
...
% Table IA.XIV CEO Turnover - Change in ROA  :  \ref{IAtab:robust_turnover_delta_roa}
\begin{papertable}{The Presence of a CMR Clause and CEO Turnover -- Change~in~ROA}{\ref{IAtab:robust_turnover_delta_roa}}{}
  ...
  \startdata
  \input{./tables/ia/table_ia_ceo_turnover_delta_roa}
% \addlinespace \textit{CMR Clause Binding:} & & & & & & \\ \textit{Average Marginal Effect}
...
% Table IA.XV CEO Turnover - No ROA  :  \ref{IAtab:robust_turnover_no_roa}
\begin{papertable}{The Presence of a CMR Clause and CEO Turnover -- Omitting~ROA}{\ref{IAtab:robust_turnover_no_roa}}{}
  ...
  \startdata
  \input{./tables/ia/table_ia_ceo_turnover_no_roa}
...
% Table IA.XVI CEO Turnover - Industry adjusted returns  :  \ref{IAtab:robust_turnover_indret}
\begin{papertable}{The Presence of a CMR Clause and CEO Turnover -- Industry~Adjusted~Returns}{\ref{IAtab:robust_turnover_indret}}{}
  ...
  \startdata
  \input{./tables/ia/table_ia_ceo_turnover_industry_returns}
% \addlinespace \textit{CMR Clause Binding:} & & & & & & \\ \textit{Average Marginal Effect}
...
% Table IA.XVII CEO Turnover - Performance interaction  :  \ref{IAtab:robust_turnover_interact}
\begin{papertable}{The Presence of a CMR Clause and CEO Turnover -- Stock~Price~Performance~Interaction}{\ref{IAtab:robust_turnover_interact}}{}
  ...
  \startdata
  \input{./tables/ia/table_ia_ceo_turnover_and_performance}
% \addlinespace \textit{CMR Clause Binding:} & & & & & & \\ \textit{Average Marginal Effect}

\end{papertable}

% Table IA.XVIII CMR and Covenant Violation (Sufi)  :  \ref{IAtab:covviol}
\begin{papertable}{The Mitigating Effect of CMRs -- Covenant~Violations~and~CEO~Turnover}{\ref{IAtab:covviol}}{}
  ...
  \startdata
  \input{./tables/ia/table_ia_ceo_turnover_cov_viol}
...
% Table IA.XIX Firm Outcome - Additional loan controls  :  \ref{IAtab:firmoutcome_loan}
\begin{landscapepapertable}{CMR Inclusion and Future Firm Performance -- Loan and Syndicate Controls}{\ref{IAtab:firmoutcome_loan}}{\skipline}
  ...
  \startdata
    \begin{tabular}{l*{10}{c}}
        ...
        \input{./tables/ia/table_ia_firm_outcome_loan_controls_tobinsq}
        \midrule
        \multicolumn{11}{c}{\small  {Panel B}: Dependent Variable = Operating Cash Flow} \\ \midrule
        \input{./tables/ia/table_ia_firm_outcome_loan_controls_oibdp_at}
        \bottomrule
    \end{tabular}
\end{landscapepapertable}
...
% Table IA.XX Key Man  :  \ref{IAtab:keyman}
\begin{papertable}{CMR Clauses and Key Man Insurance Provisions}{\ref{IAtab:keyman}}{}
  ...
  \startdata
  \input{./tables/ia/table_ia_keyman_insurance}
\end{papertable}


% Table IA.XXI Adding removing CMR clauses  :  \ref{IAtab:add_rem_cmr}
\begin{papertable}{Adding and Removing CMR Clauses}{\ref{IAtab:add_rem_cmr}}{}
    ...
    \startdata
    \input{./tables/ia/table_ia_pre_post_loan_tests}
\end{papertable}
